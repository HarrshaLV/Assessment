# -*- coding: utf-8 -*-
"""LVADSUSR89_harrshat_lab2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16S4jW6Wn7gqhD8BiSICUgrhn2Js7nILP
...
num_features = ['number of week nights', 'number of adults','number of children','number of weekend nights','number of week nights','lead time','average price']
...
"""##The sigmoid function is used in binary classification to convert catogorical values  fitting them in the sigmoid curve to classify data
